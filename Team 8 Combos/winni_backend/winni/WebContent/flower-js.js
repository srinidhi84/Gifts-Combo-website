document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        {
            ...
            id: 'redrosesbouquetwithchocolatecakeid',
            price: 1309,
            originalPrice: 1609,
            discount: 19,
            rating: 4.6,
        ...
        {
            name: 'Classic Black Forest Cake With Red Roses',
            id: 'classicblackforestcakewithredrosesid',
            price: 1269,
            originalPrice: 1569,
            discount: 19,
            rating: 4.6,
            reviews: 21,
            image: 'https://assets.winni.in/product/primary/2024/1/93463.jpeg?dpr=1&w=400',
            isFavorite: false,
            
        },
        {
            name: 'Mixed Rose Bouquet With Vanilla Cake',
            id: 'mixedrosebouquetwithvanillacakeid',
            price: 1179,
            originalPrice: 1429,
            discount: 17,
            rating: 4.7,
            reviews: 35,
            image: 'https://assets.winni.in/product/primary/2023/10/89981.jpeg?dpr=1&w=400',
            isFavorite: false,
           
        },
        {
            name: 'Ferrero Rochers With Red Roses Box',
            id: 'ferrerorocherswithredrosesboxid',
            price: 1459,
            originalPrice: 0, // Please specify the original price if available
            discount: 0, // Please specify the discount if available
            rating: 4.8,
            reviews: 40,
            image: 'https://assets.winni.in/product/primary/2023/2/82852.jpeg?dpr=1&w=400',
            isFavorite: false,
            
        },
        {
            name: 'Red Velvet Cake With Vibrant Roses',
            id: 'redvelvetcakewithvibrantrosesid',
            price: 1359,
            originalPrice: 1609,
            discount: 16,
            rating: 5.0,
        ...
        },
        {
            ...
            id: 'glitteryrosesandpineapplecakecomboid',
            price: 1479,
            originalPrice: 0, // Please specify the original price if available
            discount: 0, // Please specify the discount if available
            rating: 4.5,
 ...
 // Function to view product details
    function viewProduct(productId) {
        window.location.href = `flower-product-details.html?product=${encodeURIComponent(productId)}`;
    }
